...
var command = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		daoCfg.CompressLegacy = cfg.Chain.CompressBlock
		...
		ctx, err := cs.Blockchain().Context(context.Background())
		if err != nil {
			return errors.Wrap(err, "failed to generate context from blockchain")
		}
